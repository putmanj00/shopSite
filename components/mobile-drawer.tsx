                            ...
                            <div className="flex flex-col flex-1 px-6 py-2">
                                <nav aria-label="Primary mobile navigation" className="flex flex-col gap-6">
                                    <div className="flex flex-col gap-1">
                                        {/* Search — first in the drawer (concept 01 mobile nav) */}
                                        <Link
                                            href="/collections/all"
                                            className="text-lg font-heading font-semibold text-parchment hover:text-gold transition-colors flex items-center gap-2 py-1"
                                            onClick={closeDrawer}
                                        >
                                            <svg
                                                className="w-5 h-5"
                                        ...
                                        {/* Visit the Booth — mirrors the mobile bottom-nav Booth tab */}
                                        <Link
                                            href="/booth"
                                            className="text-lg font-heading font-semibold text-parchment hover:text-gold transition-colors block py-1"
                                            onClick={closeDrawer}
