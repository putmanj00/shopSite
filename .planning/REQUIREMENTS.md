...
- [x] **HOME-01**: Page background updated from neutral-50 to parchment
- [x] **HOME-02**: EnhancedHero replaced with HeroCard component using "Made by hand. Found by heart." tagline and forest background (no other homepage sections moved)
- [x] **HOME-03**: Category section colors and typography updated to Wildenflower palette (no icon changes, no reordering)
- [x] **HOME-04**: BotanicalDivider components added between homepage sections (after hero, after categories, after featured products)
- [x] **HOME-05**: Featured products section heading updated to "Freshly Gathered"
